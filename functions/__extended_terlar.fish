...
function __extended_terlar --description 'Write out the git prompt'
  ...
  if set -q staged[1]
    set_color --bold $fish_color_git_staged
  else
    set_color --bold $fish_color_git_dirty
  end
